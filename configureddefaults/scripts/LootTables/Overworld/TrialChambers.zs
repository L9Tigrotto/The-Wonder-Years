...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(1, 1, 0, [
            ...
            new WeightedPoolItem(<item:minecraft:honey_bottle>, 2, 2, 2),
        ...
        loot_generator.generateNEssences(1, 10);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(1, 1, 0, [
            ...
            new WeightedPoolItem(<item:minecraft:emerald_block>, 2, 1, 1)
        ]);
        ...
        loot_generator.generateNEssences(1, 5);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(1, 1, 0, [
            ...
            new WeightedPoolItem(<item:minecraft:trident>, 1, 1, 1)
        ]);
        ...
        loot_generator.generateNPotionsWithProbability(1, 0.40);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(2, 5, 8, [
            new WeightedPoolItem(<item:minecraft:emerald>, 15, 3, 3),
            new WeightedPoolItem(<item:minecraft:iron_ingot>, 12, 4, 4),
            new WeightedPoolItem(<item:minecraft:wind_charge>, 10, 5, 5),
            new WeightedPoolItem(<item:minecraft:diamond>, 8, 1, 1),
            new WeightedPoolItem(<item:minecraft:golden_apple>, 6, 1, 1),
            new WeightedPoolItem(<item:minecraft:golden_carrot>, 6, 6, 6),
            ...
            new WeightedPoolItem(<item:minecraft:honey_bottle>, 4, 2, 2),
            new WeightedPoolItem(<item:minecraft:gold_ingot>, 4, 3, 3),
            new WeightedPoolItem(<item:minecraft:amethyst_shard>, 4, 6, 6),
        ...
        loot_generator.generateNToolsWithProbability(2, 0.65);
        loot_generator.generateNWeaponsWithProbability(2, 0.60);
        loot_generator.generateNArmorsWithProbability(2, 0.55);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(1, 1, 0, [
            new WeightedPoolItem(<item:minecraft:emerald>, 5, 4, 10),
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.generateNPotionsWithProbability(2, 0.50);
        loot_generator.generateNEssences(1, 2);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.generateNPotionsWithProbability(2, 0.55);
        loot_generator.generateNEssences(1, 1);
        loot_generator.generateArtifact(1);
...
loot.modifiers.register(
    ...
    (stacks, context) => {
        ...
        loot_generator.performWeightedPool(2, 6, 5, [
            new WeightedPoolItem(<item:minecraft:emerald>, 20, 4, 10),
        ...
        loot_generator.generateNPotionsWithProbability(3, 0.70);
